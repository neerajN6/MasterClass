...
public class AMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Mentor Profile").child("AppDev");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Mentor Profile").child("AppDev");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUploadTask!=null && mUploadTask.isInProgress()){
                    Toast.makeText(AMainActivity.this, "Upload in progress.", Toast.LENGTH_SHORT).show();
                }else {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(AMainActivity.this, "Mentor Added Successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AMainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
