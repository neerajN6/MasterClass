...
public class AImageAdapter extends RecyclerView.Adapter<AImageAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;

    public AImageAdapter(Context context, List<Upload> uploads){
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public AImageAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item,parent,false);
        return new ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AImageAdapter.ImageViewHolder holder, int position) {
