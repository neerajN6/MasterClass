...
public class ATopicsActivity2 extends AppCompatActivity {
    ...
    MainActivity k;
    String calll;
    ArrayList<ATopicHelperClass2> fewAllLocatio;
        ...
        if (calll != null && calll.equals("vac")) {
            for (int i = 0; i < k.videoIds.size(); i++) {
                if (k.course_id.get(i) == 3)
                    fewAllLocatio.add(new ATopicHelperClass2(apptopics.get(k.topic.get(i)), k.vtitle.get(i), k.authorr.get(i), R.drawable.ai_logo, R.drawable.afepluslot_l));
            }
        }
...
//        }
        ...
        adapter4t = new ATopicAdapter2(fewAllLocatio);
