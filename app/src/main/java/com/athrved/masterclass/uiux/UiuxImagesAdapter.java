...
public class UiuxImagesAdapter extends RecyclerView.Adapter<UiuxImagesAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;

    public UiuxImagesAdapter(Context context, List<Upload> uploads){
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public UiuxImagesAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item,parent,false);
        return new ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull UiuxImagesAdapter.ImageViewHolder holder, int position) {
