...
public class IotTopicHelperClass2 {
    String iatopicname,iattitle,iatauthor;
    int  iatimagesmall, iatimagebig;

    public IotTopicHelperClass2() {
    }

    public IotTopicHelperClass2(String iatopicname, String iattitle, String iatauthor, int iatimagesmall, int iatimagebig) {
