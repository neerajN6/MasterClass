...
public class IotTopicHelperClass {
    String itopicname,ittitle,itauthor;
    int  itimagesmall, itimagebig;

    public IotTopicHelperClass() {
    }

    public IotTopicHelperClass(String itopicname, String ittitle, String itauthor, int itimagesmall, int itimagebig) {
