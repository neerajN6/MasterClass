...
public class IotImageAdapter extends RecyclerView.Adapter<IotImageAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;

    public IotImageAdapter(Context context, List<Upload> uploads){
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public IotImageAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item,parent,false);
        return new ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull IotImageAdapter.ImageViewHolder holder, int position) {
