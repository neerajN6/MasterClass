...
public class IotTopicsActivity2 extends AppCompatActivity {
    ...
    MainActivity k;
    String calll;
    ArrayList<IotTopicHelperClass2> fewAllLocatio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (calll != null && calll.equals("vac")) {
            for (int i = 0; i < k.videoIds.size(); i++) {
                if (k.course_id.get(i) == 6)
                    fewAllLocatio.add(new IotTopicHelperClass2(iottopics.get(k.topic.get(i)), k.vtitle.get(i), k.authorr.get(i), R.drawable.ai_logo, R.drawable.afepluslot_l));
            }
        }
...
//        }
        ...
        adapter4t = new IotTopicAdapter2(fewAllLocatio);
