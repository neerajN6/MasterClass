...
public class IotMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Mentor Profile").child("Iot");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Mentor Profile").child("Iot");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUploadTask!=null && mUploadTask.isInProgress()){
                    Toast.makeText(IotMainActivity.this, "Upload in progress.", Toast.LENGTH_SHORT).show();
                }else {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(IotMainActivity.this, "Mentor Added Successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(IotMainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
