...
public class WMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Mentor Profile").child("WebDev");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Mentor Profile").child("WebDev");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUploadTask!=null && mUploadTask.isInProgress()){
                    Toast.makeText(WMainActivity.this, "Upload in progress.", Toast.LENGTH_SHORT).show();
                }else {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(WMainActivity.this, "Mentor Added Successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(WMainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
