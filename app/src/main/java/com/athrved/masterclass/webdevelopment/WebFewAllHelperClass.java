...
public class WebFewAllHelperClass {
    ...
    public WebFewAllHelperClass() {
    }

    public WebFewAllHelperClass( int wimagebig, int wimagesmall,String wtitle, String wchannel, String wauthor) {
        this.wtitle = wtitle;
