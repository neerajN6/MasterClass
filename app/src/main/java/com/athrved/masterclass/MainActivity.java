...
//MECH
    slno.add(1);    videoIds.add("Tf3jxO-LN3k");   course_id.add(4);    paid.add(0);      topic.add(0);  authorr.add("Sudhanva");  vtitle.add("SOLIDWORKS: Machine Design");
    slno.add(2);    videoIds.add("5soHbJrzuok");   course_id.add(4);    paid.add(0);      topic.add(0);  authorr.add("Sudhanva");  vtitle.add("How Applications Are Made? ");
    slno.add(3);    videoIds.add("InigFUSiPl8");   course_id.add(4);    paid.add(0);      topic.add(1);  authorr.add("Sudhanva");  vtitle.add("Installing Android Studio & Setup");
    ...
    slno.add(7);    videoIds.add("WVjqX1BoQeM");   course_id.add(4);    paid.add(0);      topic.add(0);  authorr.add("Sudhanva"); vtitle.add("Project 1: Tic Tac Toe Game");
//AI
...
//WEB
        slno.add(1);    videoIds.add("TnTn6e4Pfn8");   course_id.add(2);    paid.add(0);      topic.add(0);   authorr.add("Sudhanva"); vtitle.add("How to become an Android Developer");
        slno.add(2);    videoIds.add("5soHbJrzuok");   course_id.add(2);    paid.add(0);      topic.add(0);   authorr.add("Sudhanva"); vtitle.add("How Applications Are Made? ");
        slno.add(3);    videoIds.add("InigFUSiPl8");   course_id.add(2);    paid.add(0);      topic.add(1);   authorr.add("Sudhanva"); vtitle.add("Installing Android Studio & Setup");
        ...
        slno.add(7);    videoIds.add("WVjqX1BoQeM");   course_id.add(2);    paid.add(0);      topic.add(0);   authorr.add("Sudhanva"); vtitle.add("Project 1: Tic Tac Toe Game Android Game");
