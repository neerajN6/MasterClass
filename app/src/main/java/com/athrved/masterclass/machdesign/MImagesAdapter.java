...
public class MImagesAdapter extends RecyclerView.Adapter<MImagesAdapter.ImageViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;

    public MImagesAdapter(Context context, List<Upload> uploads){
        mContext = context;
        mUploads = uploads;
    }
    ...
    @NonNull
    @Override
    public MImagesAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.image_item,parent,false);
        return new ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MImagesAdapter.ImageViewHolder holder, int position) {
