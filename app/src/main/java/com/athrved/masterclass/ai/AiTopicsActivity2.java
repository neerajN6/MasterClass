...
public class AiTopicsActivity2 extends AppCompatActivity {
    ...
    MainActivity k;
    String calll;
    ArrayList<AiTopicHelperClass2> fewAllLocatio;
        ...
        if (calll != null && calll.equals("vac")) {
            for (int i = 0; i < k.videoIds.size(); i++) {
                if (k.course_id.get(i) == 1)
                    fewAllLocatio.add(new AiTopicHelperClass2(aitopics.get(k.topic.get(i)), k.vtitle.get(i), k.authorr.get(i), R.drawable.ai_logo, R.drawable.afepluslot_l));
            }
        }
...
//        }
        ...
        adapter4t = new AiTopicAdapter2(fewAllLocatio);
